...
import data from "./../../data/data.json"; // Importation des données depuis data.json.
...
function Star() {
    const { Star } = data[0]; // Récupération de la valeur StarActive depuis les données. Supposons que StarActive est un champ de votre objet data.
